...
struct type_caster<std::istream> {
 ...
 public:
  static constexpr auto name() { return type_descr(_("istream")); }
  static handle cast(const std::istream* src, return_value_policy policy,
                     handle parent) {
    return none().release();
  }
...
struct type_caster<std::ostream> {
 ...
 public:
  static constexpr auto name() { return type_descr(_("ostream")); }
  static handle cast(const std::ostream* src, return_value_policy policy,
                     handle parent) {
    return none().release();
  }
