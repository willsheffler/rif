...
TEST( xform_perf, preformance ){
    ...
    cout << "Affine        d "; test_xform_perf< Eigen::Transform<double,3,Eigen::Affine> >();
    cout << "AffineCompact f "; test_xform_perf< Eigen::Transform<float ,3,Eigen::AffineCompact> >();
    cout << "Affine        f "; test_xform_perf< Eigen::Transform<float ,3,Eigen::Affine> >();
