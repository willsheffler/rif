...
struct CubicPolynomialParamsBase {
  ...
  CubicPolynomialParamsBase(Real a, Real b, Real c, Real d)
      : c0(a), c1(b), c2(c), c3(d) {}
};

template <typename Real>
Real eval_cubic_polynomial(Real const x, Real const c0, Real const c1,
                           Real const c2, Real const c3) {
...
template <typename Real>
Real cubic_polynomial_deriv(Real const x, Real const c0, Real const c1,
                            Real const c2, Real const c3) {
