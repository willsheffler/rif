...
void RIFLIB_PYBIND_numeric_pigen(py::module &pigen) {
  ...
  py::class_<Vector3f>(pigen, "Vector3f")
      ...
      .def("isApprox", [](v3f const &m, v3f const &n,
                          float prec) { return m.isApprox(n, prec); },
           py::arg("value"), py::arg("prec") = fprec)
  ...
  py::class_<m33f>(pigen, "Matrix33f")
      .def("__init__", [](m33f &instance) { instance = m33f::Identity(); })
      ...
      .def("isApprox", [](m33f const &m, m33f const &n,
                          float prec) { return m.isApprox(n, prec); },
           py::arg("value"), py::arg("prec") = fprec);

  py::class_<x3f>(pigen, "Transform3f")
      .def("__init__", [](x3f &instance) { instance = x3f::Identity(); })
      // .def( py::self == py::self )
      .def(py::self * py::self)
      // .def( py::self *= py::self )
      .def("inverse", [](x3f const &x) { return x.inverse(); })
      .def("isApprox", &x3f::isApprox, py::arg("value"),
           py::arg("prec") = fprec)
